      ...
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300">
            Ben, temiz kod ve düşünceli kullanıcı arayüzleri ile modern deneyimleri yaratmaya odaklanmış tutkulu bir geliştiriciyim.
          </p>
        </motion.div>
        ...
        <div className="grid max-w-5xl grid-cols-1 gap-10 mx-auto md:grid-cols-2">
          ...
          >
            <p className="text-gray-700 dark:text-gray-300">
              Ben, JavaScript, Python gibi modern teknolojileri kullanarak duyarlı, kullanıcı dostu uygulamaları geliştirme konusunda uzmanım.
            </p>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          >
            ...
            <div className="p-6 bg-white rounded-lg shadow-md dark:bg-slate-800">
              ...
              <div className="flex flex-wrap gap-2">
                {['Web Development', 'Open Source', 'Machine Learning', 'Game Development', 'Photography'].map(
                  (interest, index) => (
                    <motion.span
                      key={index}
