              ...
              <div className="pt-24 pb-5">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <motion.a
                      href="https://github.com/hugekayta"
                      target="_blank"
          ...
          >
            ...
            <div className="p-8 bg-white shadow-xl dark:bg-slate-800 rounded-2xl">
              <h2 className="mb-4 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
                Merhaba, Ben {discordUser?.username || '180Hz'}! 👋
              </h2>
              <p className="mb-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Deneyimli web developing ve siber güvenlik uzmanıyım. Modern, kullanıcı dostu ve güvenli web uygulamaları oluşturma konusunda tutkuluyum. Yeni teknolojiler öğrenmeyi ve yenilikçi çözümler geliştirmeyi seviyorum.
              </p>
              <div className="flex flex-wrap gap-3">
                <motion.a
                  href="#contact"
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Node.js', 'MongoDB', 'Python', 'Discord.js', 'CSharp'].map((tech, index) => (
                        <span
                          key={index}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Git', 'VS Code', 'AWS'].map((tech, index) => (
                        <span
                          key={index}
              ...
              >
                ...
                <div className="space-y-5">
                  <div className="pl-4 border-l-2 border-purple-300 dark:border-purple-700">
                    ...
                    <p className="mb-1 text-sm text-gray-500 dark:text-gray-400">Electus Technology | 2022 - Günümüz</p>
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      Modern uygulamalar geliştirme, performans optimizasyonu ve ekip liderliği.
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                {[
                  { title: 'Asus Türkiye', tech: 'Türk Asus hayranlarından oluşan topluluk sunucusu.' },
                  { title: 'Elda Craft', tech: 'Minecraft deneyimini üst seviyeye taşıyan Towny sunucusu.' },
                  { title: 'Electus BOT', tech: 'Sunucun için güvenlik, yönetim ve eğlence bir arada: Electus ile tanış' },
                ].map((project, index) => (
                  <motion.div
                    key={index}
